	...
	stages {
		...
		parallel {
			stage ('slave1-cont') {
				...
				sh "sudo mv /mnt/Dockerfile /mnt/slave1/"
				sh "sudo mv /mnt/gameoflife.war /mnt/slave1/"
				...
				sh "sudo yum install docker -y"
				sh "sudo systemctl start docker"
				sh "sudo mv /mnt/Dockerfile /mnt/slave2/"
				sh "sudo mv /mnt/gameoflife.war /mnt/slave2/"
